...
type Props = DialogProps & { onCreateAccountClick: () => void }
const SignIn: FC<Props> = ({ onCreateAccountClick, ...props }) => {
  ...
  return (
    <>
      <Dialog {...props}>
        <DialogContent>
          <div>
            <h1 className="my-6 text-center text-4xl md:my-10">Welcome Back</h1>
          ...
          <div>
            ...
            {signInWithPasswordMutation.data?.error?.message && (
            ...
            <Form
              onSubmit={(values) =>
                signInWithPasswordMutation.mutateAsync(values)
              }
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                  <Field
                    ...
                    render={({ input, meta, ...props }) => (
                      <Input {...props} {...input} placeholder="Your email" />
                    )}
                  />
                  <Field
                    name="password"
          ...
          <div className="my-6 text-center md:my-10">
            ...
            <Button onClick={() => onCreateAccountClick()} variant="link">
              Create one
            </Button>
          </div>
        </DialogContent>
...
export type { Props as SignInProps }
